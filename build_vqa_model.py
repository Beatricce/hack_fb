#%cd "/home/leonardo/hack_fb/content/content/
import os

os.chdir("/home/leonardo/hack_fb/content/")
...
class BuildVQAModel:
  ...
  def _init_processors(self):
    with open("/home/leonardo/hack_fb/content/model_data/pythia.yaml") as f:
      config = yaml.load(f)
    ...
    text_processor_config.params.vocab.vocab_file = "/home/leonardo/hack_fb/content/model_data/vocabulary_100k.txt"
    answer_processor_config.params.vocab_file = "/home/leonardo/hack_fb/content/model_data/answers_vqa.txt"
  ...
  def _build_pythia_model(self):
    state_dict = torch.load('/home/leonardo/hack_fb/content/model_data/pythia.pth', map_location='cpu')
    model_config = self.config.model_attributes.pythia
    model_config.model_data_dir = os.getcwd() + "/"
  ...
  def _build_resnet_model(self):
    ...
    self.resnet152_model.to(torch.device("cpu"))
  ...
  def predict(self, url, question):
    with torch.no_grad():
      ...
      sample_list = sample_list.to(torch.device('cpu'))
  ...
  def _build_detection_model(self):
      ...
      cfg.merge_from_file('/home/leonardo/hack_fb/content/model_data/detectron_model.yaml')
      cfg.freeze()

      model = build_detection_model(cfg)
      checkpoint = torch.load('/home/leonardo/hack_fb/content/model_data/detectron_model.pth', map_location='cpu')
  ...
  def get_resnet_features(self, image_path):
      ...
      img_transform = img_transform.unsqueeze(0).to(torch.device('cpu'))
  ...
  def get_detectron_features(self, image_path):
      ...
      current_img_list = current_img_list.to(torch.device('cpu'))
      with torch.no_grad():
